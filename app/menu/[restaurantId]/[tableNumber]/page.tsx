...
export default function MenuPage({ params }: { params: Promise<{ restaurantId: string; tableNumber: string }> }) {
  ...
  async function placeOrder() {
    ...
    if (error) { toast.error('Order failed: ' + error.message); setSubmitting(false); return }
    ...
    if (itemsError) { toast.error('Order failed: ' + itemsError.message); setSubmitting(false); return }
  ...
  if (ordered) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-orange-50 p-8 text-center">
      ...
      <p className="text-gray-500 mb-6">Your order has been sent to the kitchen. Table {tableNumber}.</p>
          ...
          <div className="bg-white w-full rounded-t-3xl p-6 max-h-[85vh] overflow-y-auto">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="e.g. No spice, no coriander"
