  ...
  return (
    <>
      <div
        ...
        className="group flex gap-4 p-4 rounded-sm hover:bg-[var(--color-brand-bg-surface)] transition-colors cursor-pointer border border-transparent hover:border-white/5"
      >
        <div className="relative w-24 h-24 sm:w-28 sm:h-28 bg-[var(--color-brand-bg-elevated)] rounded overflow-hidden shrink-0 flex items-center justify-center">
          {item.image_url ? (
            <Image
              src={item.image_url}
              alt={item.name}
