...
-- SEAFOOD
INSERT INTO menu_items (category_id, name, description, price, is_available, display_order, image_url) VALUES
('50000000-0000-0000-0000-000000000005', 'Kerala Fish Curry', 'Fresh fish simmered in a tangy Kerala-style coconut and tamarind curry with curry leaves.', 14.95, true, 1, NULL),
('50000000-0000-0000-0000-000000000005', 'Chilli Garlic Prawns', 'King prawns tossed with garlic, chilli, curry leaves and a fragrant South Indian spice blend.', 15.95, true, 2, NULL),
('50000000-0000-0000-0000-000000000005', 'Malabar Fish Fry', 'Fish fillet marinated with turmeric, chilli and coastal spices, then shallow-fried until crisp.', 13.95, true, 3, NULL),
